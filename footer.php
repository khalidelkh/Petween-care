...
?>
	      ...
	      <!-- * ---- Newsletter & footer ---- * -->
		  <section
        class="self-stretch z-10 px-5 flex flex-col items-center justify-start gap-[65px]  bg-cover bg-no-repeat bg-[top] text-[22px] text-tertialy" style="background-image: url('https://petween-care.developpement.top/wp-content/themes/petween-care-theme/assets/images/bgs/bg-footer.png');"
      >
        <!-- * ----- Newsletter ----- * -->
        <div
