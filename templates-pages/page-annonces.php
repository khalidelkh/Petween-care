...
?>
<!-- * ----- Hero ----- * -->
<section class="self-stretch h-[396px] px-5 flex flex-col items-center justify-center gap-[4px] bg-cover bg-no-repeat bg-[top] text-left text-53xl-1 text-tertialy font-ubuntu" style="background-image: url('https://petween-care.developpement.top/wp-content/themes/petween-care/assets/images/bgs/bg-news.png');">
          ...
          ?>
            <div class="z-20 shadow-2xl px-4 py-4 border border-gray-100/10 border-solid rounded-xl max-w-[364.7px] flex flex-col items-center justify-start box-border gap-[28px]">
              ...
              <div class="flex flex-col items-start justify-start gap-[23px]">
                ...
                <a href="<?= get_the_permalink() ?>" class="cursor-pointer text-[15.2px] leading-[25.97px] font-medium font-dm-sans text-tertialy [border:none] bg-pet-primary w-full rounded-3xs py-3 flex flex-col items-center justify-center">
                  LIRE PLUS
                </a>
              </div>
            </div>
