...
<!-- * ---- Main ----- * -->
<section class="w-full px-4 xl:px-0 py-32 flex flex-col items-center justify-center relative gap-[69px] text-center text-sm text-pet-primary font-myriad-pro">
  <img class="max-w-[883px] !m-[0] absolute top-[67px] left-[1037px] h-[1443px] object-cover z-[0]" alt="" src="<?= get_template_directory_uri() ?>/assets/images/paw-large.png" />
