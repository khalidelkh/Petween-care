        ...
        <div class="flex flex-col items-center justify-start gap-[86px]">
          <div class="flex flex-col items-center justify-start gap-[40px]">
            <div class="flex flex-col items-center justify-start gap-[5px]">
              ...
              <h2
                class="m-0 relative text-31xl tracking-[-1px] leading-[62px] font-medium font-ubuntu mix-blend-normal text-tertialy"
              >
                Un espace dédié
          ...
          <div
            class="min-h-[534.6px] grid grid-cols-1 md:grid-cols-2 lg:grid-cols-3 gap-[38px] text-left text-base-2 text-gray-100 font-dm-sans"
          >
          <?php
        if ($annonces) :
            ...
            >
              ...
              <div class="flex flex-col items-start justify-start gap-[23px]">
                <div class="flex flex-col items-start justify-start gap-[9px]">
                  <div
                    class="flex flex-col items-start justify-start gap-[4px] text-center text-pet-primary"
                  >
                    <span
                  ...
                  <span
                    class="w-[108.2px] rounded bg-whitesmoke-100 h-[28.1px] flex flex-col items-center justify-center"
                  >
                  <?= $title ?>
                  </span>
                </div>
